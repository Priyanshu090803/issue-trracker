  ...
  return (
    <div className=' h-screen w-full flex justify-center'>  
        <div className=' border  h-fit py-10 px-24 shadow-xl rounded-2xl  shadow-neutral-300 flex  flex-col items-center gap-5'>        
            ...
            <textarea name="" placeholder='Description' id="" rows={4}  className=' px-4 w-full py-2 border border-neutral-300 text-neutral-700 text-sm focus:outline-1 focus: outline-gray-400 rounded-lg'/>
